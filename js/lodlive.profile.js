...
$.jStorage.set('language', {
	it : {
		...
		resourceMissingDoc : 'non sono state trovate proprietà di tipo literal per la risorsa per la lingua impostata o la risorsa non è del tutto presente nell\'endpoint',
		options : 'OPZIONI',
